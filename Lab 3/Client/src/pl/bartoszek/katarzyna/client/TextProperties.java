...
/**
 * The class is responsible for creating the file with extension .properties for the client.
...
public class TextProperties {
    ...
    /**
     * Allows to get the server address.
     ...
     * Port number and address saved in the Properties file need to be the same both for the client and the server.
     */
    void saveProperties() {
        Properties properties = new Properties();
